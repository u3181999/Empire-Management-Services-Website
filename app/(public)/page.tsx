          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="mt-4 text-gray-600 leading-relaxed">
                We build genuine partnerships with our clients, resulting in long-term relationships and
                numerous repeat projects. Our operations manager maintains constant communication to
                ensure the right work is always being done.
              </p>
